...
<body style="background: #D4D4D4;">
    <div class="container d-flex flex-column justify-content-center align-items-center" style="min-height: 100vh;">
        ...
        <div class="mb-4 d-flex justify-content-evenly w-25">
            <a href="parkir1.php"><button type="button" class="btn btn-light fw-bold" style="box-shadow: 9px 5px 10px 2px #000; ">Slot 1</button></a>
            <a href="#"><button type="button" class="btn btn-warning fw-bold" style="box-shadow: 9px 5px 10px 2px #000">Slot 2</button></a>
            <a href="parkir3.php"><button type="button" class="btn btn-info fw-bold" style="box-shadow: 9px 5px 10px 2px #000">Slot 3</button></a>
        </div>

        <div class="card p-4" style="width: 40%; box-shadow: 9px 5px 10px 4px #000;">
            <h3 class="text-center mb-3 fw-bold" style="font-family: 'Poppins';">Slot 2</h3>
            <div style="max-height: 300px; overflow-y: auto;">
                <table class="table table-striped text-center">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM log_parkir WHERE status IN ('masuk', 'keluar') AND slot = 2";
